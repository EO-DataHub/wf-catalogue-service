...
from wf_catalogue_service.utils.logging import get_logger, timing_context
...
@patch("wf_catalogue_service.utils.logging.time.time", MagicMock(side_effect=[100.0, 101.0]))
