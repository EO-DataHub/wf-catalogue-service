...
IMAGE_NAME=wf-catalogue-service
CONTAINER_NAME=wf-catalogue-service
DOCKERFILE_PATH=.
...
testcov:
	@rm -rf htmlcov
	uv run pytest -v --cov-report html --cov-report xml --cov=src/wf_catalogue_service tests/
